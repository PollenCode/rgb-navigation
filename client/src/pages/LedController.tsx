        ...
        <div className="flex items-center flex-col min-h-screen justify-center">
            <h1 className="text-4xl font-bold mb-8">LedController</h1>
                <div className="flex flex-row">
                    ...
                    <input type="number" id="quantity" name="quantity" min="0" max="50" defaultValue="0" onChange={event => setStartLed(event.target.value)} className="border-black h-5 mr-5 "></input>
                    <p className="mr-5 text-lg">End led:</p>
                    <input type="number" id="quantity" name="quantity" min="0" max="50" defaultValue="50" onChange={event => setEndLed(event.target.value)} className="border-black h-5 mr-5 "></input>
                    <p className="mr-5 text-lg">Tijd:</p>
                    <input type="number" id="quantity" name="quantity" min="1" defaultValue="1" onChange={event => setDuration(event.target.value)} className="border-black h-5 mr-5 "></input>
